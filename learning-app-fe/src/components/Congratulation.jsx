      ...
      <div className="w-[95%] sm:w-[70%]">
        <div className="flex w-full items-center justify-center">
          <div
            ...
            className="ml-2 w-[70%] rounded-xl bg-white p-4 font-mono"
          >
            <ul className="flex justify-center items-center text-center text-2xl font-bold">
              <li>
                <img src='/images/congru.png' className="w-12 h-12" />
              </li>
              <li className="ml-2">
                CHÚC MỪNG
              </li>
            ...
            <p className="text-center font-mono">Bạn đã nhận được: </p>
            <ul className="mx-auto mt-3 mb-3 flex w-[90%] sm:w-[60%] justify-around text-left text-xl font-bold">
              <li className="flex">
                {lessons[currentLesson - 1].gems}
                <img src="/images/logo/coins.png" className="ml-1 h-6 w-6" />
              </li>
              <li className="flex">
                {lessons[currentLesson - 1].experiences}
                <img src="/images/logo/explogo.jfif" className="ml-1 h-6 w-6" />
              </li>
              <li className="flex">
                <span>5</span>
                <img src="/images/logo/heart.webp" className="ml-1 h-6 w-6" />
              </li>
            </ul>
        ...
        <div className="flex items-center justify-center">
          <img src="/images/cat_congru1.png" className="h-[10rem] w-[10rem]" />
          {/* <img src="/images/cat_congru2.png" className="h-[10rem] w-[10rem]" /> */}
        </div>
      </div>
    </div>
  );
